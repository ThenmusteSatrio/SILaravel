...
<body class="bg-slate-950">
  ...
  <div class="container max-w-full mx-auto">
    ...
    <nav class="border-gray-400 bg-gray-800  max-w-full mx-auto ">
      ...
      <span class="absolute text-white text-4xl top-5 left-4 cursor-pointer" onclick="Open()">
        <svg class="w-6 h-6 text-yellow-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
  ...
  <div class="sidebar z-10 fixed top-0 bottom-0  left[300px] p-2 w-[-300px] overflow-y-auto text-center bg-gray-900">
    <div class="text-gray-100 text-xl">
      <div class="p-2 flex items-center">
        ...
        <h1 class="font-bold text-gray-200 text-[15px] ml-3">SuperAdmin</h1>
  ...
  <nav class="border-gray-400 bg-gray-800  max-w-full mx-auto ">
    <img id="avatarButton" type="button" data-dropdown-toggle="userDropdownId" data-dropdown-placement="bottom-start" class="w-14 h-14 rounded-full cursor-pointer  mx-auto mr-2" src="images/smk2.png" alt="User dropdown">
